...
test-perf:
	...
	do \
		...
		MARIONETTE_RUNNER_HOST=$(MARIONETTE_RUNNER_HOST) GAIA_DIR=`pwd` CURRENT_APP=$$app NPM_REGISTRY=$(NPM_REGISTRY) ./bin/gaia-marionette ./tests/js/perf.js $${SHARED_PERF} $${FILES_PERF} ;\
	done; \
	echo ']';
